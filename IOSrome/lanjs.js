...
function prepareLanJPanel(url){
    ...
    if(url.indexOf("h5.m.taobao.com/awp/core/detail.htm") > 0){
        //alert("awp");
        document.getElementById("J_newDetail").parentNode.insertBefore(JP, document.getElementById("J_newDetail"));
    }else if(url.indexOf("detail.m.tmall.com/item.htm") > 0){
        //alert("tmall");
